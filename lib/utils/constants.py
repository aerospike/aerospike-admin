...
SERVER_SINDEX_INTEGER_TYPE_FIRST_VERSION = "8.2.0"  # "numeric" type renamed "integer"
SERVER_SINDEX_ON_AEL_FIRST_VERSION = "8.2.0"  # server compiles AEL source itself
SERVER_MEMORY_ALLOC_STATS_FIRST_VERSION = "8.2.0"  # index/sindex alloc + cgroup stats
