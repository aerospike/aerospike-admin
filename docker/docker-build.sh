...
function resolve_packages() {
  local pkg_amd64="aerospike-asadm_${PKG_VERSION}-${ITERATION}ubuntu24.04_amd64.deb"
  local pkg_arm64="aerospike-asadm_${PKG_VERSION}-${ITERATION}ubuntu24.04_arm64.deb"
