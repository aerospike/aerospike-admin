...
#
# The sed prints whatever follows the "=", so the result is shape-checked: a
# trailing inline comment or stray whitespace would otherwise sail through into
# a deployment target and a cache key.
#
