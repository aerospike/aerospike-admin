...
class OperationTest(unittest.TestCase):
    def test_BinaryOperation(self):
        ...
        self.assertEqual(result, expected, "BinaryOperation.operate did not return the expected result")
    ...
    def test_ApplyOperation(self):
        ...
        expected = (True, [])
        self.assertEqual(result, expected, "ApplyOperation.operate did not return the expected result")
    ...
    def test_SimpleOperation(self):
        ...
        self.assertEqual(result, expected, "SimpleOperation.operate did not return the expected result")
    ...
    def test_AggOperation(self):
        ...
        expected = {('C1', 'CLUSTER'): {('NS2', 'NAMESPACE'): (5.0, []), ('NS1', 'NAMESPACE'): (1.0, [])}}
        self.assertEqual(result, expected, "AggOperation.operate did not return the expected result")
    ...
    def test_ComplexOperation(self):
        ...
        result = op.operate(arg1=arg1, group_by=["CLUSTER", "NODE"], result_comp_op="==", result_comp_val=(1, []))
        expected = {('C1', 'CLUSTER'): {('N1', 'NODE'): (True, [])}}
        self.assertEqual(result, expected, "ComplexOperation.operate did not return the expected result")
    ...
    def test_AssertDetailOperation(self):
        ...
        result = op.operate(data=data, check_val=(2, []), error="error", category="category", level="level", description="description", success_msg="success")
        expected = ('assert_result',
                    {'Category': ['CATEGORY'],
                     ...
                     'Failmsg': 'error',
                     'Keys': [
                         ('C1/N1/NS1/CONFIG1', None), ('C1/N1/NS2/CONFIG3', None)
                     ],
                     'Success': False
                     }
                    )
        self.assertEqual(result, expected, "AssertDetailOperation.operate did not return the expected result")