...
class NodeTest(unittest.TestCase):
    ...
    def test_info_get_config(self):
        ...
        n.info_namespaces.return_value = [
            "test_two",
        ]
        n.info_get_config("all")
        n.info_namespaces.assert_called()
        n._info_cinfo.assert_any_call("get-config:context=namespace;id=test_two", n.ip)
    ...
    def test_info_latency_with_args(self):
        ...
        self.assertEqual(
            n.info_latency(back=300, duration=120, slice_tm=30),
            expected,
            "info_latency with args did not return the expected result",
        )
        n._info_cinfo.assert_called_with(
            "latency:back=300;duration=120;slice=30;", n.ip
        )
    ...
    def test_info_roster(self):
        n = self.get_info_mock(
            "ns=test:roster=null:pending_roster=null:observed_nodes=BB9070016AE4202,BB9060016AE4202,BB9050016AE4202,BB9040016AE4202,BB9020016AE4202"
        )
        expected = {
            "test": {
                "observed_nodes": [
        ...
        self.assertEqual(
            n.info_roster(), expected, "info_roster did not return the expected result"
        )
    ...
    def test_info_racks(self):
        ...
        self.assertEqual(
            n.info_racks(), expected, "info_racks did not return the expected result"
        )
    ...
    def test_info_histogram(self):
        ...
        self.assertEqual(
            n.info_histogram("objsz"),
            expected,
            "info_histogram did not return the expected result",
        )
        n._info_cinfo.assert_called_with(
            "histogram:namespace=test;type=object-size-linear", n.ip
        )
        ...
        n._info_cinfo.assert_called_with(
            "histogram:namespace=test;type=object-size", n.ip
        )
    ...
    def test_info_latencies_verbose(self):
        ...
        n._info_cinfo.assert_called_with(
            "latencies:hist={test}-benchmarks-batch-sub", n.ip
        )
