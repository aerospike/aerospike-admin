...
from lib.client.info import ASProtocolError, ASResponse
...
class ASSocketTestConnect(unittest.TestCase):
    ...
    @patch("socket.socket")
    @patch("socket.getaddrinfo")
    @patch("lib.client.assocket.SSL.Connection")
    ...
    @patch("lib.client.assocket.info")
    ...
    @patch("lib.client.assocket.login")
    ...
    @patch("lib.client.assocket.authenticate_old")
    @patch("lib.client.assocket.authenticate_new")
    ...
    @patch("lib.client.assocket.create_user")
    ...
    @patch("lib.client.assocket.drop_user")
    ...
    @patch("lib.client.assocket.set_password")
    ...
    @patch("lib.client.assocket.change_password")
    ...
    @patch("lib.client.assocket.grant_roles")
    ...
    @patch("lib.client.assocket.revoke_roles")
    ...
    @patch("lib.client.assocket.query_users")
    ...
    @patch("lib.client.assocket.query_user")
    ...
    @patch("lib.client.assocket.create_role")
    ...
    @patch("lib.client.assocket.delete_role")
    ...
    @patch("lib.client.assocket.add_privileges")
    ...
    @patch("lib.client.assocket.delete_privileges")
    ...
    @patch("lib.client.assocket.set_whitelist")
    ...
    @patch("lib.client.assocket.delete_whitelist")
    ...
    @patch("lib.client.assocket.query_roles")
    ...
    @patch("lib.client.assocket.query_role")
