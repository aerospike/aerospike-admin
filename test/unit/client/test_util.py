...
class UtilTest(unittest.TestCase):
    ...
    def test_info_to_dict_multi_level(self):
        ...
        result = util.info_to_dict_multi_level(
            value,
            ["dc-name", "DC_Name"],
            delimiter1=";",
            delimiter2=":",
    ...
    def test_find_dns(self):
        self.assertEqual(
            util.find_dns(None), None, "find_dns did not return the expected result"
        )
        self.assertEqual(
            util.find_dns([]), None, "find_dns did not return the expected result"
        )
