...
class ShowUdfsControllerTest(asynctest.TestCase):
    def setUp(self):
        warnings.filterwarnings("error", category=PytestUnraisableExceptionWarning)
    ...
    async def test_show_udfs_list_success(self, mock_get_udf_controller):
    ...
    @patch("lib.live_cluster.show_controller.GetUdfController")
    async def test_show_single_udf_success(self, mock_get_udf_controller):
    ...
    @patch("lib.live_cluster.show_controller.GetUdfController")
    async def test_show_single_udf_exception_error(self, mock_get_udf_controller):
    ...
    @patch("lib.live_cluster.show_controller.GetUdfController")
    async def test_show_single_udf_aerospike_error(self, mock_get_udf_controller):
    ...
    @patch("lib.live_cluster.show_controller.GetUdfController")
    async def test_show_single_udf_base64_decode_error(self, mock_get_udf_controller):
    ...
    @patch("lib.live_cluster.show_controller.GetUdfController")
    async def test_show_single_udf_with_modifiers(self, mock_get_udf_controller):
    ...
    @patch("lib.live_cluster.show_controller.GetUdfController")
    async def test_show_single_udf_empty_content(self, mock_get_udf_controller):
    ...
    @patch("lib.live_cluster.show_controller.GetUdfController")
    async def test_show_single_udf_missing_type(self, mock_get_udf_controller):
    ...
    @patch("lib.live_cluster.show_controller.GetUdfController")
    async def test_show_single_udf_missing_content(self, mock_get_udf_controller):
