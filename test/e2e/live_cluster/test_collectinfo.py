...
class TestCollectinfo(asynctest.TestCase):
    ...
    CMDS = [
        ...
        ("show config namespace", ["title", "storage-engine.file[0]", "storage-engine.stripe[0]", "conflict-resolution-policy", "mrt-duration", "read-consistency-level-override", "replication-factor", "strong-consistency", "write-commit-level-override"], None),
        ...
        ("show statistics sets", ["title", "ns", "set", "objects", "data_used_bytes", "disable-eviction", "enable-index"], None),
